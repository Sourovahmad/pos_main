$(document).ready(function () {
    ...
    $("#orderCompleteButton").attr("disabled", false);
        ...
        $("#orderCompleteButton").on('click', function () {
            ...
            var purchaseData={
                purchase_id : $('#purchase_input_id').val(),
            ...
            var act = $("#homeRoute").val().trim()+'/stock-entry-store'; 
    ...
    $("#purchaseProductInputId")
        ...
        .on("keydown", function (e) {
            ...
            if (e.keyCode == 40) {
                ...
                const purcahseid = $("#purchase_input_id").val();
                if (purcahseid == ''){
                    alert("please Select the purchase first");
                    $("#supplierSearchField").focus();
                    return
                }
                e.preventDefault();
    ...
    $(document).on("click", "#resetButton", function () {
        var isConfirmed = confirm("Are You sure want To Reset ? all of the changes will be cleared");
        if(isConfirmed) {
            location.reload(true);
        } else {
         return false;
