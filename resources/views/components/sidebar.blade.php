...
<ul class="navbar-nav    sidebar sidebar-dark accordion bg-abasas-dark " id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseProducts" class="collapse" aria-labelledby="headingProducts" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                @can('Product Page')
                <a class="collapse-item" href="{{ route('products.excelImport') }}">{{__('translate.Excel import')}}</a>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed  p-3 " href="{{ route('stock-entry') }}"   aria-expanded="true" aria-controls="collapseStaff">
            <i class="fas fa-chart-line"></i>
            <span> {{__('translate.Stock Entry')}} </span>
        </a>
