                    ...
                    <tfoot class="bg-abasas-dark">
                      ...
                      <tbody>
                        ...
                        <tr class="data-row">
                            ...
                            <td class="  word-break name "> {{ $itemId}}</td>
         
                            <td class="  word-break name "> {{ $item->name}}</td>
                        
                            <td class="  word-break category_id"> {{ $item->category->name}}</td>
                      
                            <td class="  word-break price"> {{ $item->price_per_unit}}</td>
                     

                            
                            <td class="  word-break tax"> {{ $item->tax}}</td>
                        

                            
                        <td class="  word-break stock"> {{ $item->stock}}</td>
                 



                            
                        <td class="  word-break warrenty"> {{ $item->warrenty->name}}</td>
