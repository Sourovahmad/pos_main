    ...
    <div class="col-12 col-md-8">
        ...
        <div class="card mb-4 shadow">
            ...
            <div class="card-header py-3 bg-abasas-dark  text-light ">
                <nav class="navbar ">
                    <span><a class="navbar-brand">{{ __('translate.Stock Entry') }}</a> @can('Super Admin') <i class="fas fa-tools pl-2"
                        id="pageSetting" data-toggle="modal" data-target="#setting-modal"></i> @endcan </span>

                        <span><button class="btn btn-success mt-3" type="button" id="resetButton">Reset</button></span>
                </nav>
                    ...
                    -->
                        ...
                        <div class="col-auto">
                            <button type="button" id="purchaseProductInputSubmit" data-submit-type="create"
                                data-item-id="0" class="btn btn-success mt-3" > {{ __('translate.Submit') }}</button>
                        </div>
                    ...
                    <div class="row mb-2 mt-4">
                        <div class="input-group col-12">
                            <input type="text" class="form-control inputMinZero " id="PayAmount"
                                aria-describedby="inputGroupAppend" value="0" required disabled>
...
<script src="{{ asset('js/abasas/stockEntry.js') }}"></script>
