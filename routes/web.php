...
Route::get('excel-import', [ProductController::class,"excelImport"])->name('products.excelImport');
...
Route::get('stock-entry',[StockAlertController::class, "returnStockEntryPage"])->name('stock-entry');
Route::post('stock-entry-store',[StockAlertController::class, "storeStocks"])->name('stock-entry-store');
